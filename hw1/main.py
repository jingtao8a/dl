...
def train_valid_split(data_set, valid_ratio, seed):
    ...
    train_set, valid_set = random_split(dataset=data_set, lengths=[train_set_size, valid_set_size], generator=torch.Generator().manual_seed(seed))
...
def trainer(train_loader, valid_loader, model, config, device):
    ...
    if not os.path.isdir('./models'):
        os.mkdir('./models') # directory o saving models
